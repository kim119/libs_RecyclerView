...
import com.mj.libs_recyclerview.cell.EmptyCell;
import com.mj.libs_recyclerview.cell.ErrorCell;
import com.mj.libs_recyclerview.cell.LoadMoreCell;
import com.mj.libs_recyclerview.cell.LoadingCell;
        ...
        if(manager instanceof GridLayoutManager){
            ...
            gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup(){
                ...
                public int getSpanSize(int position) {
                    ...
                    return (viewType==ERROR_TYPE||viewType==EMPTY_TYPE||viewType==LOADING_TYPE||viewType==LOAD_MORE_TYPE)?gridLayoutManager.getSpanCount():1;
                }
            });
